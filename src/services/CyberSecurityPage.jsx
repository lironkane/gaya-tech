            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, index) => (
                <article key={index} className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300">
                  ...
                  <h3 className="text-xl font-heebo font-bold mb-4 text-[#124A36] text-center">{service.title}</h3>
                  <p className="text-gray-600 font-assistant text-center">{service.description}</p>
                </article>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="text-4xl font-bold text-white mb-2 font-heebo">{stat.number}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-white rounded-2xl p-8 shadow-sm">
                  <h3 className="text-xl font-heebo font-bold mb-6 text-[#124A36]">{solution.title}</h3>
